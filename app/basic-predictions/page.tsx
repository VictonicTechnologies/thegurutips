...
import { ArrowRight, ArrowLeft, Calendar, Clock, Star, Lock } from "lucide-react";
import Image from "next/image";
import { motion } from "framer-motion";
import Link from "next/link";
import { SubscriptionModal } from "@/components/SubscriptionModal";
import { getBasicPredictions } from '@/lib/api';
import type { Prediction } from '@/lib/api';
import { LoadingSpinner } from '@/components/LoadingSpinner';
import { Progress } from "@/components/ui/progress";

export default function BasicPredictions() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setProgress(30);
        const data = await getBasicPredictions();
        setProgress(70);
        setPredictions(data);
      } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          >
            <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white px-6 py-2 rounded-full text-sm font-semibold uppercase tracking-wider">
          ...
          >
            Get access to our professional analysis with detailed insights and higher success rates.
          </motion.p>
        </div>
        ...
        {isSubscribed ? (
            ...
            {predictions.map((prediction, index) => (
              ...
              >
                <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 border-t border-gray-700 bg-gradient-to-r from-gray-900 to-gray-800">
                  <div className="absolute inset-0 bg-blue-500 opacity-5 group-hover:opacity-10 transition-opacity duration-300" />
                  <div className="p-6">
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-700 pt-4">
                        <div className="flex items-center gap-6 mb-4 md:mb-0">
                          ...
                          <div className="text-center">
                            ...
                            <p className="font-semibold text-blue-500">{prediction.odds}</p>
                          </div>
                          <div className="text-center">
                            <p className="text-sm text-gray-400">Confidence</p>
                            <p className="font-semibold text-emerald-500">{prediction.confidence}</p>
                          </div>
                        </div>
          ...
          <Card className="relative overflow-hidden border-t border-gray-700 bg-gradient-to-r from-gray-900 to-gray-800 p-8">
            ...
            <div className="relative text-center">
              <Lock className="w-20 h-20 mx-auto mb-6 text-blue-500" />
              <h2 className="text-2xl font-bold text-white mb-4">Subscribe to Access Basic Analysis</h2>
              <p className="text-gray-300 mb-8">
                Get access to 50+ premium insights monthly, expert analysis, and success probability ratings.
              </p>
              <Button 
